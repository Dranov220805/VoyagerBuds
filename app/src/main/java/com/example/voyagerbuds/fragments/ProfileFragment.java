...
public class ProfileFragment extends Fragment {
        ...
        public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
                ...
                SharedPreferences prefs = requireContext().getSharedPreferences("VoyagerBudsPrefs",
                ...
                btnRestoreData.setOnClickListener(v -> {
                        if (!com.example.voyagerbuds.utils.UserSessionManager.isUserLoggedIn()) {
                                android.widget.Toast
                                                .makeText(getContext(), getString(R.string.restore_login_prompt),
                        ...
                        com.example.voyagerbuds.firebase.FirebaseBackupManager.fetchBackupPreview(requireContext(),
                                        mAuth, dbHelper,
                                        new com.example.voyagerbuds.firebase.FirebaseBackupManager.PreviewCallback() {
                                                ...
                                                public void onPreview(
                                                        ...
                                                        int localSchedules = dbHelper
                                                                        .getTotalSchedulesForUser(localUserId);
                                                        int localExpenses = dbHelper
                                                                        .getTotalExpensesForUser(localUserId);
                                                        int localCaptures = dbHelper
                                                                        .getTotalCapturesForUser(localUserId);

                                                        // Inflate a custom preview dialog with a UX-friendly view
                                                        View dialogView = LayoutInflater.from(requireContext())
                                                                        .inflate(R.layout.dialog_restore_preview, null);
                                                        TextView tvLocalCounts = dialogView
                                                                        .findViewById(R.id.tv_local_counts);
                                                        TextView tvRemoteCounts = dialogView
                                                                        .findViewById(R.id.tv_remote_counts);
                                                        LinearLayout sampleTripsContainer = dialogView
                                                                        .findViewById(R.id.sampleTripsContainer);
                                                        MaterialButton btnOverwrite = dialogView
                                                                        .findViewById(R.id.btn_overwrite);
                                                        MaterialButton btnMerge = dialogView
                                                                        .findViewById(R.id.btn_merge);
                                                        MaterialButton btnAppend = dialogView
                                                                        .findViewById(R.id.btn_append);
                                                        ...
                                                        String localCounts = " • "
                                                                        ...
                                                                        + requireContext().getResources()
                                                                                        .getQuantityString(
                                                                                                        R.plurals.n_expenses,
                                                                                                        localExpenses,
                                                                                                        localExpenses)
                                                                        + "\n" + " • " + requireContext().getResources()
                                                                                        .getQuantityString(
                                                                                                        R.plurals.n_captures,
                                                                                                        localCaptures,
                                                                                                        localCaptures);
                                                        String remoteCounts = requireContext().getResources()
                                                                        .getQuantityString(R.plurals.n_trips,
                                                                                        preview.tripCount,
                                                                                        preview.tripCount)
                                                                        + "\n" + " • "
                                                                        + requireContext().getResources()
                                                        ...
                                                        for (int i = 0; i < toShow; i++) {
                                                                com.example.voyagerbuds.firebase.FirebaseBackupManager.TripSummary ts = preview.trips
                                                                                .get(i);
                                                                View item = LayoutInflater.from(requireContext())
                                                                                .inflate(R.layout.item_remote_trip_preview,
                                                                                                sampleTripsContainer,
                                                                                                false);
                                                                TextView title = item.findViewById(
                                                                                R.id.tv_remote_trip_title);
                                                                TextView subtext = item.findViewById(
                                                                                R.id.tv_remote_trip_subtext);
                                                                title.setText(ts.tripName);
                                                                String tsCounts = requireContext().getResources()
                                                                                .getQuantityString(
                                                                                                R.plurals.n_schedules,
                                                                                                ts.scheduleCount,
                                                                                                ts.scheduleCount)
                                                        ...
                                                        if (preview.trips.size() > toShow) {
                                                                ...
                                                                more.setText(String.format(requireContext()
                                                                                .getString(R.string.more_indicator),
                                                                                (preview.trips.size() - toShow)));
                                                                more.setTextAppearance(requireContext(),
                                                                                android.R.style.TextAppearance_Small);
                                                                sampleTripsContainer.addView(more);
                                                        }

                                                        // Make the AlertDialog
                                                        AlertDialog previewDialog = new AlertDialog.Builder(
                                                                        requireContext())
                                                                        .setView(dialogView)
                                                                        .create();

                                                        // Header cancel button
                                                        android.widget.ImageButton btnCancelDialog = dialogView
                                                                        .findViewById(R.id.btn_dialog_cancel);
                                                        btnCancelDialog.setOnClickListener(
                                                                        v -> previewDialog.dismiss());

                                                        // Overwrite button
                                                        btnOverwrite.setOnClickListener(btn -> {
                                                                android.app.AlertDialog confirm = new android.app.AlertDialog.Builder(
                                                                                requireContext())
                                                                                .setTitle(getString(
                                                                                                R.string.confirm_overwrite_title))
                                                                                .setMessage(getString(
                                                                                                R.string.confirm_overwrite_message))
                                                                                .setPositiveButton(android.R.string.yes,
                                                                                                (c2, a2) -> {
                                                                                                        android.app.AlertDialog pr = new android.app.AlertDialog.Builder(
                                                                                                                        requireContext())
                                                                                                                        .setTitle(getString(
                                                                                                                                        R.string.restoring_title))
                                                                                                                        .setMessage(getString(
                                                                                                                                        R.string.restoring_message_overwrite))
                                                                                                                        .setCancelable(false)
                                                                                                                        .create();
                                                                                                        pr.show();
                                                        ...
                                                        btnMerge.setOnClickListener(btn -> {
                                                                new AlertDialog.Builder(requireContext())
                                                                                .setTitle(getString(
                                                                                                R.string.confirm_merge_title))
                                                                                .setMessage(getString(
                                                                                                R.string.confirm_merge_message))
                                                                                .setPositiveButton(android.R.string.yes,
                                                                                                (d, w) -> {
                                                                                                        android.app.AlertDialog pr = new android.app.AlertDialog.Builder(
                                                                                                                        requireContext())
                                                                                                                        .setTitle(getString(
                                                                                                                                        R.string.restoring_title))
                                                                                                                        .setMessage(getString(
                                                                                                                                        R.string.restoring_message_merge))
                                                                                                                        .setCancelable(false)
                                                                                                                        .create();
                                                                                                        pr.show();
                                                                                                        com.example.voyagerbuds.firebase.FirebaseBackupManager
                                                                                                                        .restoreAllData(requireContext(),
                                                                                                                                        mAuth,
                                                                                                                                        dbHelper,
                                                        ...
                                                        btnAppend.setOnClickListener(btn -> {
                                                                new AlertDialog.Builder(requireContext())
                                                                                .setTitle(getString(
                                                                                                R.string.confirm_append_title))
                                                                                .setMessage(getString(
                                                                                                R.string.confirm_append_message))
                                                                                .setPositiveButton(android.R.string.yes,
                                                                                                (d, w) -> {
                                                                                                        android.app.AlertDialog pr = new android.app.AlertDialog.Builder(
                                                                                                                        requireContext())
                                                                                                                        .setTitle(getString(
                                                                                                                                        R.string.restoring_title))
                                                                                                                        .setMessage(getString(
                                                                                                                                        R.string.restoring_message_append))
                                                                                                                        .setCancelable(false)
                                                                                                                        .create();
                                                                                                        pr.show();
                                                                                                        com.example.voyagerbuds.firebase.FirebaseBackupManager
                                                ...
                                                public void onFailure(String error) {
                                                        ...
                                                        new AlertDialog.Builder(requireContext())
                                                                        .setTitle(getString(
                                                                                        R.string.restore_preview_failed_title))
                                                                        .setMessage(error)
                ...
                btnBackupData.setOnClickListener(v -> {
                        if (!com.example.voyagerbuds.utils.UserSessionManager.isUserLoggedIn()) {
                                android.widget.Toast
                                                .makeText(getContext(), getString(R.string.backup_login_prompt),
                                                                android.widget.Toast.LENGTH_SHORT)
                                                .show();
                                return;
                        }
                        ...
                        com.example.voyagerbuds.firebase.FirebaseBackupManager.backupAllData(requireContext(), mAuth,
                                        dbHelper,
                                        new com.example.voyagerbuds.firebase.FirebaseBackupManager.Callback() {
                                                @Override
                                                public void onSuccess() {
                                                ...
                                                public void onFailure(String error) {
                                                        progress.dismiss();
                                                        android.util.Log.w("ProfileFragment",
                                                                        "Backup failed: " + error);
                                                        new android.app.AlertDialog.Builder(requireContext())
                                                                        .setTitle(getString(
                                                                                        R.string.backup_failed_title))
                                                                        .setMessage(error)
                                                                        .setPositiveButton(getString(
                                                                                        R.string.copy_details),
                                                                                        (d, w) -> {
                                                                                                android.content.ClipboardManager clipboard = (android.content.ClipboardManager) requireContext()
                                                                                                                .getSystemService(
                                                                                                                                android.content.Context.CLIPBOARD_SERVICE);
                                                                                                android.content.ClipData clip = android.content.ClipData
                                                                                                                .newPlainText("backup_error",
                                                                                                                                error);
                                                                                                if (clipboard != null)
                                                                                                        clipboard.setPrimaryClip(
                                                                                                                        clip);
                ...
                btnTestFirestore.setOnClickListener(v -> {
                        ...
                        DatabaseHelper dbHelper = new DatabaseHelper(requireContext());
                        com.example.voyagerbuds.firebase.FirebaseBackupManager.preflightCheck(requireContext(), mAuth,
                                        dbHelper,
                                        new com.example.voyagerbuds.firebase.FirebaseBackupManager.Callback() {
                                                @Override
                                                public void onSuccess() {
                                                                                        ...
                                                                                        (d, w) -> {
                                                                                                android.content.ClipboardManager clipboard = (android.content.ClipboardManager) requireContext()
                                                                                                                .getSystemService(
                                                                                                                                android.content.Context.CLIPBOARD_SERVICE);
                                                                                                android.content.ClipData clip = android.content.ClipData
                                                                                                                .newPlainText("firestore_test_success",
                                                                                                                                message);
                                                                                                if (clipboard != null)
                                                                                                        clipboard.setPrimaryClip(
                                                                                                                        clip);
                                                ...
                                                public void onFailure(String error) {
                                                        new AlertDialog.Builder(requireContext())
                                                                        .setTitle(getString(
                                                                                        R.string.firestore_test_failed_title))
                                                                        .setMessage(error)
                                                                        .setPositiveButton(android.R.string.ok, null)
                                                                        .show();
                                                }
