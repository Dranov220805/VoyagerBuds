...
public class ProfileFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    SharedPreferences prefs =
        requireContext().getSharedPreferences("VoyagerBudsPrefs", Context.MODE_PRIVATE);
          ...
          com.example.voyagerbuds.firebase.FirebaseBackupManager.fetchBackupPreview(
              ...
              new com.example.voyagerbuds.firebase.FirebaseBackupManager.PreviewCallback() {
                ...
                public void onPreview(
                    com.example.voyagerbuds.firebase.FirebaseBackupManager.BackupPreview
                        preview) {
                  progress.dismiss();
                  // Compute local counts
                  int localUserId =
                      com.example.voyagerbuds.utils.UserSessionManager.getCurrentUserId(
                          requireContext());
                  ...
                  LinearLayout sampleTripsContainer =
                      dialogView.findViewById(R.id.sampleTripsContainer);
                  ...
                  for (int i = 0; i < toShow; i++) {
                    com.example.voyagerbuds.firebase.FirebaseBackupManager.TripSummary ts =
                        preview.trips.get(i);
                    View item =
                        LayoutInflater.from(requireContext())
                            .inflate(
                  ...
                  AlertDialog previewDialog =
                      new AlertDialog.Builder(requireContext()).setView(dialogView).create();

                  // Header cancel button
                  android.widget.ImageButton btnCancelDialog =
                  ...
                  btnOverwrite.setOnClickListener(
                      btn -> {
                        android.app.AlertDialog confirm =
                            new android.app.AlertDialog.Builder(requireContext())
                                    ...
                                    (c2, a2) -> {
                                      ...
                                      com.example.voyagerbuds.firebase.FirebaseBackupManager
                                          .restoreAllData(
                                              ...
                                              new com.example.voyagerbuds.firebase
                                                  .FirebaseBackupManager.Callback() {
                                                @Override
                                ...
                                (d, w) -> {
                                  ...
                                  com.example.voyagerbuds.firebase.FirebaseBackupManager
                                      .restoreAllData(
                                          ...
                                          new com.example.voyagerbuds.firebase.FirebaseBackupManager
                                              .Callback() {
                                            @Override
                                            public void onSuccess() {
                                              pr.dismiss();
                  ...
                  new android.app.AlertDialog.Builder(requireContext())
                      ...
                      .setPositiveButton(
                          ...
                          (d, w) -> {
                            ...
                            android.content.ClipData clip =
                                android.content.ClipData.newPlainText("backup_error", error);
          ...
          com.example.voyagerbuds.firebase.FirebaseBackupManager.preflightCheck(
              ...
              new com.example.voyagerbuds.firebase.FirebaseBackupManager.Callback() {
                ...
                public void onSuccess() {
                  ...
                  String uid =
                      mAuth.getCurrentUser() != null ? mAuth.getCurrentUser().getUid() : "(none)";
                  String projectId =
                      com.google.firebase.FirebaseApp.getInstance().getOptions().getProjectId();
                  String message =
                      "Preflight check successful — you can write to Firestore.\nUID: "
                          + uid
                          + "\nProject ID: "
                          + projectId;
                  new AlertDialog.Builder(requireContext())
